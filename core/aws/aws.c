...
int aws_json_dumps_device_status(const iot_device_status_t * source, char * dest, size_t buffer_size)
{
    ...
    if (source->presence_flags & IOT_LAST_LOG_FILE_READ_POS_BITMASK)
    {
    ...
    // last_gps_location
    if (source->presence_flags & IOT_LAST_GPS_LOCATION_BITMASK)
    {
    ...
    // battery_level
    if (source->presence_flags & IOT_BATTERY_LEVEL_BITMASK)
    {
    ...
    // battery_voltage
    if (source->presence_flags & IOT_BATTERY_VOLTAGE_BITMASK)
    {
    ...
    if (source->presence_flags & IOT_LAST_CELLULAR_CONNECTED_TIMESTAMP_BITMASK)
    {
    ...
    if (source->presence_flags & IOT_LAST_SAT_TX_TIMESTAMP_BITMASK)
    {
    ...
    if (source->presence_flags & IOT_NEXT_SAT_TX_TIMESTAMP_BITMASK)
    {
    ...
    if (source->presence_flags & IOT_CONFIGURATION_VERSION_BITMASK)
    {
    ...
    // firmware_version
    if (source->presence_flags & IOT_FIRMWARE_VERSION_BITMASK)
    {
...
static void aws_json_parse_device_status(const char * source, iot_device_status_t * dest, size_t buffer_size)
{
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_LAST_LOG_FILE_READ_POS_BITMASK;
    }
    ...
    if (member_ptr)
    {
        ...
        dest->presence_flags |= IOT_LAST_GPS_LOCATION_BITMASK;
    }
invalid:
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_BATTERY_LEVEL_BITMASK;
    }
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_BATTERY_VOLTAGE_BITMASK;
    }
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_LAST_CELLULAR_CONNECTED_TIMESTAMP_BITMASK;
    }
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_LAST_SAT_TX_TIMESTAMP_BITMASK;
    }
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_NEXT_SAT_TX_TIMESTAMP_BITMASK;
    }
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_CONFIGURATION_VERSION_BITMASK;
    }
    ...
    if (member_ptr)
    {
        ...
        if (ret >= 0)
            dest->presence_flags |= IOT_FIRMWARE_VERSION_BITMASK;
    }
}
...
static void aws_json_parse_device_update(const char * source, iot_device_update_t * dest, size_t buffer_size)
{
    ...
    dest->presence_flags |= IOT_CONFIGURATION_UPDATE_BITMASK;
...
invalid_config:
    ...
    dest->presence_flags |= IOT_FIRMWARE_UPDATE_BITMASK;
