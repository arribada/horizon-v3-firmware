...
static void (*GPIO_callback_function[GPIO_TOTAL_NUMBER])(syshal_gpio_event_t);
...
public:
    ...
    static int syshal_gpio_enable_interrupt_GTest(uint32_t pin, void (*callback_function)(syshal_gpio_event_t), int cmock_num_calls) {GPIO_callback_function[pin] = callback_function; return SYSHAL_GPIO_NO_ERROR;}
