 ...
 */
static void syshal_axl_int1_ag_interrupt_priv(syshal_gpio_event_t event)
{
...
int syshal_axl_init(void)
{
    ...
    uint16_t sample_rate = find_closest_value_priv(sys_config.axl_sample_rate.contents.sample_rate, valid_sample_rate_options, sizeof(valid_sample_rate_options));
