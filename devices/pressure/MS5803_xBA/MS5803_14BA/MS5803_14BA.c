...
int32_t MS5803_get_pressure(void)
{
    ...
    OFF = ((int64_t)MS5803_xBA_coefficient[2] << 16) + (((MS5803_xBA_coefficient[4] * (int64_t)dT)) >> 7);

    // Sensitivity at actual temperature
    // SENS = C1 * 2^15 + ( C3 * dT ) / 2^8
    SENS = ((int64_t)MS5803_xBA_coefficient[1] << 15) + (((MS5803_xBA_coefficient[3] * (int64_t)dT)) >> 8);
